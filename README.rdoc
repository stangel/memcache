...
=== Testing
  ...
  bundle exec rake test runs all the tests.

  if you're not security conscious, you can do the following:
...
Copyright (c) 2025 Geni.com; Published under The MIT License, see the LICENSE file.
